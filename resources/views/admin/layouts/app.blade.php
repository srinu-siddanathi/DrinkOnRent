            ...
            <div class="flex flex-col h-screen">
                ...
                <nav class="flex-1 px-6 py-6">
                    <div class="space-y-4">
                        ...
                        <a href="{{ route('admin.purifier-requests.index') }}"
                           class="hidden flex items-center px-4 py-3 text-base rounded-lg transition-colors duration-200 
                               {{ request()->routeIs('admin.purifier-requests.*') ? 'bg-indigo-600 text-white' : 'text-gray-100 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
                            <span class="font-medium">Purifier Requests</span>
                        </a>
                        ...
                        <a href="{{ route('admin.services.index') }}"
                           class="flex items-center px-4 py-3 text-base rounded-lg transition-colors duration-200
                               {{ request()->routeIs('admin.services.*') ? 'bg-indigo-600 text-white' : 'text-gray-100 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="font-medium">New Services</span>
                        </a>
